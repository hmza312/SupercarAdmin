import { Avatar, Badge, Center, Text, Flex, Table, TableCaption, TableContainer, Tbody, Td, Tfoot, Th, Thead, Tr, useMediaQuery, Box } from "@chakra-ui/react";
import WhiteButton from "./design/WhiteButton";
import ContentHeader from "./design/ContentHeader";
import { ViewIcon } from "@chakra-ui/icons";

export default function Payments () {
    return <Flex width="100%" flexDir="column" gap="1rem" height="100%" pb={'2rem'}> 
...
const PaymentsTable = ()=> {
    ...
    return <TableContainer p = {under800 ? '0.2rem' :'1rem'} overflowY={'auto'}>
